...
import type { User, PlanningWeek, Task } from '../../types'
...
/**
 * Vue principale du planning généré
 */
export function PlanningView({ planning, users, stats, onReset }: PlanningViewProps): JSX.Element {
