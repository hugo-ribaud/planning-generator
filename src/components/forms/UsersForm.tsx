  ...
  return (
    <>
        ...
        <div className="flex items-start gap-4">
          ...
          <div className="flex-1 space-y-3">
            ...
            <fieldset>
              ...
              <div className="flex flex-wrap gap-2" role="group" aria-label="Selection des jours off">
      ...
      <ConfirmDialog
        ...
        message={`L'utilisateur "${userName}" sera definitivement supprime ainsi que toutes ses taches assignees.`}
