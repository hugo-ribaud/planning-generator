...
/**
 * ShoppingCategory - Une categorie de la liste de courses
 * @param {Object} props
 * @param {Object} props.category - La categorie
 * @param {Array} props.users - Liste des utilisateurs
 * @param {Function} props.onUpdateCategory - Mise a jour de la categorie
 * @param {Function} props.onRemoveCategory - Suppression de la categorie
 * @param {Function} props.onAddItem - Ajout d'un item
 * @param {Function} props.onUpdateItem - Mise a jour d'un item
 * @param {Function} props.onRemoveItem - Suppression d'un item
 * @param {Function} props.onToggleItem - Toggle check item
 * @param {Function} props.onAssignItem - Assignation item
 */
export function ShoppingCategory({
  ...
  const checkedCount = category.items.filter(item => item.is_checked).length
      ...
      >
        ...
        <div className="flex items-center gap-2">
          ...
          <button
            onClick={(e) => {
              e.stopPropagation()
              if (confirm('Supprimer cette categorie et tous ses articles ?')) {
