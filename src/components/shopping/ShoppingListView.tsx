...
import { Button, Input, Card, ConfirmDialog } from '../ui'
  ...
  return (
    <>
      ...
      <ConfirmDialog
        ...
        title="Supprimer les articles coches ?"
        message={`${stats.checkedItems} article(s) coche(s) seront definitivement supprimes de la liste.`}
      ...
      <ConfirmDialog
        ...
        title="Reinitialiser la liste ?"
        message="Toutes les categories et articles personnalises seront supprimes et remplaces par la liste par defaut."
