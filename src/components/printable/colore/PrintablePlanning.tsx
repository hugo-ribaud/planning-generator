...
import type { Task, User, Milestone, PlanningWeek, PlanningConfig } from '../../../types'
 ...
 */
function PrintButton({ onClick }: PrintButtonProps): JSX.Element {
  return (
    <button
      onClick={onClick}
      className="
 ...
 */
function ColorLegend({ users }: ColorLegendProps): JSX.Element {
  return (
...
interface PrintablePlanningConfig extends Partial<PlanningConfig> {
  periodType?: 'week' | 'biweek' | 'month'
  periodCount?: number
}

export interface PrintablePlanningProps {
  tasks?: Task[]
  users?: User[]
  milestones?: Milestone[]
  planning?: PlanningWeek | null
  config?: PrintablePlanningConfig
  title?: string
}
...
export interface PrintablePlanningPreviewProps {
  tasks?: Task[]
  users?: User[]
  milestones?: Milestone[]
  planning?: PlanningWeek | null
...
export function PrintablePlanningPreview({
  ...
  config = {},
  onClose,
}: PrintablePlanningPreviewProps): JSX.Element {
  return (
