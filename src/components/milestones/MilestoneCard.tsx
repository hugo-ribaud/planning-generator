...
export function MilestoneCard({
  ...
  const milestoneTitle = milestone.title || 'Sans titre'
  ...
  return (
    <>
        ...
        <div className="flex items-start justify-between gap-3 mb-3">
          ...
          <div className="flex items-center gap-1">
            ...
            <Button
              ...
              aria-label={`Supprimer le milestone ${milestoneTitle}`}
            >
              x
            </Button>
          </div>
      ...
      <ConfirmDialog
        ...
        title="Supprimer ce milestone ?"
        message={`Le milestone "${milestoneTitle}" sera definitivement supprime.`}
